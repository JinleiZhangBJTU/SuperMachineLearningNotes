...
```
符号$:=$表示覆盖操作。从公式中可以看出，在梯度下降求解过程中要不断的去更新<img src="https://latex.codecogs.com/gif.latex?W">
...
假设神经网络有$L$层，为了简单起见，每一层的参数$b^l$为0，所有的激活函数定义为：<img src="https://latex.codecogs.com/gif.latex?g(z)=z"> ，除此之外，每层的连接权重$W^l$拥有相同的权重：<img src="https://latex.codecogs.com/gif.latex?W^{[l]}=\left(\begin{array}{cc}&space;1.5&space;&&space;0\\&space;0&space;&&space;1.5&space;\end{array}\right)"> 。
